  ...
  return (
    ...
    >
      ...
      >
        ...
        making our field more inclusive and therefore enthusiastically welcome
        proposals that address Indigenous and non-Western media cultures and
        contexts. <u>We look forward to seeing you in Calgary next June</u>!
      </Content>
      ...
      >
        ...
        running as a <strong>primarily in-person event</strong>. However, we
        will have a limited number of online panels (between 3 - 5 panels) in
        order to make the conference accessible to those unable to travel. If
        you are interested in participating virtually, follow the submission
        directions below. Please note that you will not be able to switch your
        modality once you make your submission and that mixed modality
        pre-constituted panels or roundtables will not be accepted. In other
        words, pre-constituted panels/roundtables must consist of all in-person
        or all virtual papers. Registration fees for online participation will
        be the same as in-person fees.
      </Content>
      <HeadingMid variants={commonAnimationVariants}>
        Proposal Guidelines
      </HeadingMid>
      ...
      >
        ...
        Tamara Shepherd, Samantha Thrift, Department of Communication, Media and
        Film, University of Calgary
      </Content>
    </Layout>
  );
};
